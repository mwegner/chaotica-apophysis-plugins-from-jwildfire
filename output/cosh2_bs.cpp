...
/*
    Apophysis Plugin: cosh2_bs

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/Cosh2_BSFunc.java
...
#define APO_VARIABLE_PREFIX "cosh2_bs_"
#include "plugin.h"
...
int PluginVarCalc(Variation* vp)
{
    ...
    double coshsin = sin(FTy * VAR(y1));
    double coshcos = cos(FTy * VAR(y2));
    double coshsinh = sinh(FTx * VAR(x1));
    double coshcosh = cosh(FTx * VAR(x2));
    FPx += VVAR * coshcosh * coshcos;
    FPy += VVAR * coshsinh * coshsin;
...
// 
// public class Cosh2_BSFunc extends VariationFunc {
