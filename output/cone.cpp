...
/*
    Apophysis Plugin: cone

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/ConeFunc.java
...
#define APO_VARIABLE_PREFIX "cone_"
#include "plugin.h"
