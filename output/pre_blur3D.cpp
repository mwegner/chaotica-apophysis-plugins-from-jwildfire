...
int PluginVarCalc(Variation* vp)
{
    ...
    double r = VVAR * (VAR(_gauss_rnd)[0] + VAR(_gauss_rnd)[1] + VAR(_gauss_rnd)[2] + VAR(_gauss_rnd)[3] + VAR(_gauss_rnd)[4] + VAR(_gauss_rnd)[5] - 3);
    ...
    FTx += r * VAR(_sinb) * VAR(_cosa);
    FTy += r * VAR(_sinb) * VAR(_sina);
    FTz += r * VAR(_cosb);
