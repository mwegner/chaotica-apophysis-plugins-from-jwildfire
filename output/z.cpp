...
/*
    ...
    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/ZFunc.java
...
int PluginVarCalc(Variation* vp)
{
    ...
    r = VVAR * (sqrt(sqr(FTx) + sqr(FTy)) + total);
...
//     }
// 
//     r = pAmount * (sqrt(sqr(pAffineTP.x) + sqr(pAffineTP.y)) + total);
// 
//     s = sin(a);
//     c = cos(a);
// 
