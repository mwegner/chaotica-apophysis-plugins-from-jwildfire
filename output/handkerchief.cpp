...
/*
    Apophysis Plugin: handkerchief

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/HandkerchiefFunc.java
...
#define APO_VARIABLE_PREFIX "handkerchief_"
#include "plugin.h"
...
int PluginVarCalc(Variation* vp)
{
    ...
    FPx += VVAR * (sin(angle + r) * r);
    FPy += VVAR * (cos(angle - r) * r);
