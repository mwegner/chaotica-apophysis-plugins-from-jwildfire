...
/*
    Apophysis Plugin: rays1

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/Rays1Func.java
...
#define APO_VARIABLE_PREFIX "rays1_"
#include "plugin.h"
...
int PluginVarCalc(Variation* vp)
{
    ...
    double u = 1.0 / tan(sqrt(t)) + (VVAR * sqr(M_2_PI));
