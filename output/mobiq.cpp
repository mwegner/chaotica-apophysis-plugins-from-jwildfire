...
/*
    Apophysis Plugin: mobiq

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/MobiqFunc.java
...
*/
    ...
    FPx += (nt * dt + nx * dx + ny * dy + nz * dz) * ni;
    FPy += (nx * dt - nt * dx - ny * dz + nz * dy) * ni;
    FPz += (ny * dt - nt * dy - nz * dx + nx * dz) * ni;
