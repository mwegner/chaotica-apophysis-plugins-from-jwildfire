...
/*
    Apophysis Plugin: rsquares_js

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/RsquaresFunc.java
...
#define APO_VARIABLE_PREFIX "rsquares_js_"
#include "plugin.h"

APO_PLUGIN("rsquares_js");
APO_VARIABLES(
	VAR_INTEGER(level, 2),
