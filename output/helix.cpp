...
/*
    Apophysis Plugin: helix

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/HelixFunc.java
...
#define APO_VARIABLE_PREFIX "helix_"
#include "plugin.h"
...
int PluginVarCalc(Variation* vp)
{
    ...
    double s = sin(FTz * M_2PI * VAR(frequency));
    double c = cos(FTz * M_2PI * VAR(frequency));

    FPx += VVAR * (FTx + c * VAR(width));
    FPy += VVAR * (FTy + s * VAR(width));
    FPz += VVAR * FTz;
