...
/*
    Apophysis Plugin: bwraps7

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/BWraps7Func.java
...
#define APO_VARIABLE_PREFIX "bwraps7_"
#include "plugin.h"
...
int PluginVarPrepare(Variation* vp)
{
    ...
    VAR(_g2) = VAR(gain) * VAR(gain) + 1.0e-6;
