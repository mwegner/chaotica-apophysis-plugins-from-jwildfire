...
/*
    Apophysis Plugin: dc_randomoctree

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/DC_RandomOctreeFunc.java
...
#define APO_VARIABLE_PREFIX "dc_randomoctree_"
#include "plugin.h"

APO_PLUGIN("dc_randomoctree");
APO_VARIABLES(
