...
/*
    Apophysis Plugin: truchet2

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/Truchet2Func.java
...
APO_PLUGIN("truchet2");
APO_VARIABLES(
	VAR_REAL(exponent1, 1.0),
	VAR_REAL(exponent2, 2.0),
	VAR_REAL(width1, 0.5),
	VAR_REAL(width2, 0.5),
	VAR_REAL(scale, 10.0),
	VAR_REAL(seed, 50.0),
