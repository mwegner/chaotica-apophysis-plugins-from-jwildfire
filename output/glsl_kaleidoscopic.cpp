...
/*
    Apophysis Plugin: glsl_kaleidoscopic

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/GLSLKaleidoscopicFunc.java
...
int PluginVarCalc(Variation* vp)
{
    ...
    int i = (int) (GOODRAND_01() * VAR(_resolutionX));
    int j = (int) (GOODRAND_01() * VAR(_resolutionY));
    ...
    FPx += VVAR * ((double) (i) / VAR(_resolutionX) - 0.5);
    FPy += VVAR * ((double) (j) / VAR(_resolutionY) - 0.5);
