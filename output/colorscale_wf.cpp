...
/*
    Apophysis Plugin: colorscale_wf

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/ColorScaleWFFunc.java
...
{
    FPx += VVAR * VAR(scale_x) * FTx;
    FPy += VVAR * VAR(scale_y) * FTy;
