...
/*
    Apophysis Plugin: dc_code

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/DC_CodeFunc.java
...
#define APO_VARIABLE_PREFIX "dc_code_"
#include "plugin.h"
