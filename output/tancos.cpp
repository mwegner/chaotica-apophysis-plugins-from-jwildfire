...
/*
    Apophysis Plugin: tancos

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/TanCosFunc.java
...
#define APO_VARIABLE_PREFIX "tancos_"
#include "plugin.h"
...
int PluginVarCalc(Variation* vp)
{
    ...
    double d1 = SMALL_EPSILON + sqr(FTx) + sqr(FTy);
    double d2 = VVAR / d1;
    FPx += d2 * (tanh(d1) * (2.0 * FTx));
    FPy += d2 * (cos(d1) * (2.0 * FTy));
