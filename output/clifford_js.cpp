...
int PluginVarCalc(Variation* vp)
{
    ...
    //		  xn+1 = sin(VAR(_a) yn) + VAR(_c) cos(VAR(_a) xn)
    //		  yn+1 = sin(VAR(_b) xn) + VAR(_d) cos(VAR(_b) yn)

    double x = sin(VAR(_a) * FTy) + VAR(_c) * cos(VAR(_a) * FTx);
    double y = sin(VAR(_b) * FTx) + VAR(_d) * cos(VAR(_b) * FTy);
