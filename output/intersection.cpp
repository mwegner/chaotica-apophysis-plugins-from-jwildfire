...
/*
    Apophysis Plugin: intersection

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/IntersectionFunc.java
...
APO_PLUGIN("intersection");
APO_VARIABLES(
	VAR_REAL(xwidth, 5.0),
	VAR_REAL(xtilesize, 0.50),
	VAR_REAL(xmod1, 0.30),
	VAR_REAL(xmod2, 1.0),
	VAR_REAL(xheight, 0.50),
	VAR_REAL(yheight, 5.0),
...
{
    VAR(_xr1) = VAR(xmod2) * VAR(xmod1);
    VAR(_yr1) = VAR(ymod2) * VAR(ymod1);
