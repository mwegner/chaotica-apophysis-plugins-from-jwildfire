...
/*
    Apophysis Plugin: hilbert_js

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/HilbertFunc.java
...
#define APO_VARIABLE_PREFIX "hilbert_js_"
#include "plugin.h"

APO_PLUGIN("hilbert_js");
APO_VARIABLES(
	VAR_INTEGER(level, 2),
