...
/*
    Apophysis Plugin: glsl_mandala

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/GLSLMandalaFunc.java
...
typedef struct
{
	...
	double _mX = 0.025;
	double _mY = 0.0; // -0.001245675
	double _scale = 2.0;
	double _sides = 12.0;
	double _multiply = 1.5;
	double _loops = 64.0;
	int _iR;
	int _iG;
	int _iB = 1;
