...
/*
    Apophysis Plugin: dc_mandala

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/DC_MandalaFunc.java
...
#define APO_VARIABLE_PREFIX "dc_mandala_"
#include "plugin.h"

APO_PLUGIN("dc_mandala");
APO_VARIABLES(
