...
/*
    Apophysis Plugin: tanhq

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/TanhqFunc.java
...
#define APO_VARIABLE_PREFIX "tanhq_"
#include "plugin.h"
