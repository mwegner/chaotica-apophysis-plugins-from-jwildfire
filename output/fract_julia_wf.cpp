...
/*
    Apophysis Plugin: fract_julia_wf

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/FractJuliaWFFunc.java
...
#define APO_VARIABLE_PREFIX "fract_julia_wf_"
#include "plugin.h"

APO_PLUGIN("fract_julia_wf");
APO_VARIABLES(
	VAR_INTEGER(power, 0),
	VAR_REAL(xseed, 0),
	VAR_REAL(yseed, 0),
