...
/*
    Apophysis Plugin: glynnspiro

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/GlynnSpiroGraf3DFunc.java
...
#define APO_VARIABLE_PREFIX "glynnspiro_"
#include "plugin.h"

APO_PLUGIN("glynnspiro");
APO_VARIABLES(
	VAR_REAL(radius, 1.0),
