...
/*
    Apophysis Plugin: dc_layers

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/DC_LayersFunc.java
...
#define APO_VARIABLE_PREFIX "dc_layers_"
#include "plugin.h"

APO_PLUGIN("dc_layers");
APO_VARIABLES(
