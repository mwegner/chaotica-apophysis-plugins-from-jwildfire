...
/*
    Apophysis Plugin: dc_hyperbolictile

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/DC_HyperbolicFunc.java
...
#define APO_VARIABLE_PREFIX "dc_hyperbolictile_"
#include "plugin.h"

APO_PLUGIN("dc_hyperbolictile");
APO_VARIABLES(
