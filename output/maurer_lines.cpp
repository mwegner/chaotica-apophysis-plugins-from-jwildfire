...
/*
    Apophysis Plugin: maurer_lines

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/MaurerLinesFunc.java
...
const int POLYGON = 1;
const int ELLIPSE = 2;
const int RHODONEA = 3;
const int EPITROCHOID = 4;
const int HYPOTROCHOID = 5;
const int LISSAJOUS = 6;
const int EPISPIRAL = 7;
const int SUPERSHAPE = 8;
const int STARR_CURVE = 9;
const int FARRIS_MYSTERY_CURVE = 10;
const int WAGON_FANCIFUL_CURVE = 11;
const int FAY_BUTTERFLY = 12;
const int RIGGE1 = 13;
const int RIGGE2 = 14;
const int RIGGED_RHODONEA_PLUS = 15;
const int RIGGED_RHODONEA_MINUS = 16;
const int SUPER_ELLIPSE = 17;
const int SUPER_RHODONEA = 18;
const int DEFAULT = 0;
const int NORMAL = 0;
const int NONE = 0;
const int OFF = 0;
const int LINES = 1;
const int CIRCLES = 2;
const int ELLIPSES = 3;
const int SINE_WAVES = 4;
const int QUADRATIC_BEZIER = 5;
const int SEQUIN_CIRCLE_SPLINE = 9;
const int CUBIC_HERMITE_SPLINE = 10;
const int CARDINAL_SPLINE = 11;
const int UNIFORM_CATMULL_ROM_SPLINE = 12;
const int NONUNIFORM_CATMULL_ROM_SPLINE = 13;
const int CHORDAL_CATMULL_ROM_SPLINE = 14;
const int CENTRIPETAL_CATMULL_ROM_SPLINE = 15;
const int KOCHANEK_BARTELS_SPLINE = 16;
const int CUBIC_HERMITE_HAPPY_ACCIDENT1 = 17;
const int CUBIC_HERMITE_HAPPY_ACCIDENT2 = 18;
const int CUBIC_HERMITE_HAPPY_ACCIDENT3 = 19;
const int CUBIC_HERMITE_HAPPY_ACCIDENT4 = 20;
const int CUBIC_HERMITE_HAPPY_ACCIDENT5 = 21;
const int CARDINAL_SPLINE_SWIZZLE1 = 6;
const int CARDINAL_SPLINE_SWIZZLE2 = 7;
const int CARDINAL_SPLINE_SWIZZLE3 = 8;
const int KOCHANEK_BARTELS_SPLINE_SWIZZLE1 = 22;
const int KOCHANEK_BARTELS_SPLINE_SWIZZLE2 = 23;
const int KOCHANEK_BARTELS_SPLINE_SWIZZLE3 = 24;
const int CUBIC_HERMITE_TANGENT_FORM2 = 25;
const int STROKE = 1;
const int REFLECTED_STROKE = 2;
const int BOTH_STROKE = 3;
const int ALTERNATING_STROKE = 4;
const int FILL_TO_LINE = 5;
const int REFLECTED_FILL_TO_LINE = 6;
const int BOTH_FILL_TO_LINE = 7;
const int ALTERNATING_FILL_TO_LINE = 8;
const int FILL_TO_CURVE = 9;
const int REFLECTED_FILL_TO_CURVE = 10;
const int BOTH_FILL_TO_CURVE = 11;
const int ALTERNATING_FILL_TO_CURVE = 12;
const int FILL_BETWEEN_LINE_CURVE = 13;
const int FILL_BETWEEN_LINE_CURVE_SWIZZLE = 14;
const int Z_STROKE = 15;
const int Z_REFLECTED_STROKE = 16;
const int Z_BOTH_STROKE = 17;
const int Z_ALTERNATING_STROKE = 18;
const int TANGENT = 1;
const int UNIT_TANGENT = 2;
const int UNSCALED_TANGENT = 3;
const int UNSCALED_UNIT_TANGENT = 4;
const int NORMAL_VECTOR = 5;
const int UNIT_NORMAL = 6;
const int UNSCALED_NORMAL = 7;
const int UNSCALED_UNIT_NORMAL = 8;
const int ROTATION_TANGENT = 9;
const int THETA_TANGENT = 10;
const int INDEX_TANGENT = 11;
const int XY_SCALE_TANGENT = 12;
const int NO_COSETS = 0;
const int CLASSIC_COSETS = 1;
const int CLOSURE_COSETS = 2;
const int HYBRID_COSETS = 3;
const int COLORMAP_CLAMP = 1;
const int COLORMAP_WRAP = 2;
const int RED_GREEN = 3;
const int RED_BLUE = 4;
const int BLUE_GREEN = 5;
const int LINE_LENGTH_LINES = 1;
const int LINE_ANGLE_LINES = 2;
const int POINT_ANGLE_LINES = 3;
const int META_INDEX = 4;
const int Z_MINMAX_POINTS = 5;
const int Z_ABSOLUTE_MINMAX_POINTS = 6;
const int DISTANCE_ALONG_LINE_POINTS = 7;
const int DISTANCE_FROM_MIDLINE_POINTS = 8;
const int DISTANCE_FROM_NEAREST_END_POINTS = 9;
const int SPEED_AT_ENDPOINT1 = 10;
const int CURRENT_THETA = 11;
const int PERCENT = 0;
const int VALUE = 1;
const int BAND_PASS_VALUE = 1;
const int BAND_STOP_VALUE = 2;
const int BAND_PASS_PERCENT = 3;
const int BAND_STOP_PERCENT = 4;
const int AND = 0;
const int OR = 1;
const int XOR = 2;
const int ANOTB = 3;
const int BNOTA = 4;
const int LINE_OFFSET_INCREMENT = 1;
const int A_LINEAR_INCREMENT = 2;
const int B_LINEAR_INCREMENT = 3;
const int C_LINEAR_INCREMENT = 4;
const int D_LINEAR_INCREMENT = 5;
const int E_LINEAR_INCREMENT = 6;
const int F_LINEAR_INCREMENT = 7;
const int INITIAL_OFFSET = 8;
const int A_B_LINEAR_INCREMENT = 9;
const int RENDER_MODIFIER1 = 10;
const int RENDER_MODIFIER2 = 11;
const int RENDER_MODIFIER3 = 12;
const int RANDOM = 0;
const int PERPENDICULAR = 1;
const int ROUNDED_CAPS = 2;

typedef struct
{
	bool _DEBUG_META_MODE = false;
	bool _DEBUG_SAMPLING = false;
	bool _DEBUG_DYNAMIC_PARAMETERS = false;
	bool _DEBUG_COSETS = false;
	bool _DEBUG_COSETS_INIT = false;
	bool _DEBUG_TANGENTS = false;
	double a;
	double b;
	double c;
	double d;
	...
	double _h;
	double line_count;
	double theta_step_size;  // specified in degrees
	double initial_theta; // specified in degrees
	double render_mode; // DEFAULT
	double render_submode; // DEFAULT
	double tangent_submode; // DEFAULT
	double render_modifier1;
	double render_modifier2;
	double render_modifier3;
	double _theta_step_radians;
	double _initial_theta_radians;
	double _cycles; // 1 cycle = 2*PI
	double show_points;
	double show_curve;
	double _line_thickness_strategy = 0.0; // RANDOM
	...
	bool diff_mode;
	int curve_mode; // RHODONEA
	int direct_color_gradient; // OFF
	int direct_color_measure; // LINE_LENGTH_LINES
	int direct_color_thresholding; // PERCENT
	double color_low_threshold;
	double color_high_threshold;
	int number_of_filters;
	int meta_mode; // OFF
	double meta_min_step;
	double meta_max_step;
	double _meta_step_value = 1;
	double _current_meta_step;
	double _meta_steps;
	int cosets_mode;
	int _coset_d;
	int _coset_z;
	int _coset_gcd;
	int _coset_lcm;
	double _lines_per_coset;
	double _coset_step_size;
	double _coset_count;
	double _cycles_to_close_curve;
	double _cycles_to_close_polyline;
	double _radians_to_close_curve;
	double _radians_to_close_polyline;
	double irrationalize;
	bool randomize;
	int _sample_size = 1000;
	double _sampled_line_lengths[1];
	double _sampled_line_angles[1];
	double _sampled_point_angles[1];
...
APO_VARIABLES(
	...
	VAR_REAL(g, 1),
	VAR_REAL(h, 1),
	VAR_REAL(line_count, 360),
	VAR_REAL(theta_step_size, 71),
	VAR_REAL(initial_theta, 0),
	VAR_REAL(render_mode, DEFAULT),
	VAR_REAL(render_submode, DEFAULT),
	VAR_REAL(tangent_submode, DEFAULT),
	VAR_REAL(render_modifier1, 1.0),
	VAR_REAL(render_modifier2, 1.0),
	VAR_REAL(render_modifier3, 1.0),
	VAR_REAL(show_points, 0),
	VAR_REAL(show_curve, 0),
	VAR_REAL(line_thickness, 0.1),
	VAR_REAL(point_thickness, 1),
	VAR_REAL(curve_thickness, 0.5),
	VAR_INTEGER(diff_mode, 1),
	VAR_INTEGER(curve_mode, RHODONEA),
	VAR_INTEGER(direct_color_gradient, OFF),
	VAR_INTEGER(direct_color_measure, LINE_LENGTH_LINES),
	VAR_INTEGER(direct_color_thresholding, PERCENT),
	VAR_REAL(color_low_threshold, 0.3),
	VAR_REAL(color_high_threshold, 2.0),
	VAR_INTEGER(number_of_filters, 0),
	VAR_INTEGER(meta_mode, OFF),
	VAR_REAL(meta_min_step, 30),
...
int gcd (Variation* vp, int a, int b) {

    BigInteger aBig = BigInteger.valueOf(VAR(_a));
    BigInteger bBig = BigInteger.valueOf(VAR(_b));
    BigInteger result = aBig.gcd(vp, bBig);  // BigInteger.VAR(_coset_gcd) always returns postivie (or zero)
    return result.intValue();
}

int lcm (Variation* vp, int a, int b) {

    return abs(VAR(_a)) * (abs(VAR(_b)) / gcd(vp, VAR(_a), VAR(_b)));
}

double getPointAngle (Variation* vp, DoublePoint3D point1, DoublePoint3D point2) {
...
void setCurveParams (Variation* vp) {
...
void setValues (Variation* vp) {

    setCurveParams(vp);

    if (VAR(cosets_mode) != NO_COSETS) {
      VAR(_theta_step_radians) = VAR(_coset_step_size);
      VAR(_cycles) = VAR(_cycles_to_close_polyline);
      // if relatively prime, then don't use cosets
      if (VAR(_coset_gcd) == 1) {  // relatively prime if don't share VAR(_a) common denominator other than 1
        VAR(_initial_theta_radians) = 0;
        if (VAR(_DEBUG_COSETS) && count % 50000 == 0) {
          System.out.println("gcd is 1, lcm: " + VAR(_coset_lcm) + ", VAR(_cycles): " + VAR(_cycles) + ", zero initial_offset");
        }
      } else {
        if (VAR(cosets_mode) == CLASSIC_COSETS) {
          int coset_id = (int) (floor(GOODRAND_01() * VAR(_coset_gcd)));
          VAR(_initial_theta_radians) = M_2PI * ((double) coset_id / (double) VAR(_coset_z));
        } else if (VAR(cosets_mode) == CLOSURE_COSETS || VAR(cosets_mode) == HYBRID_COSETS) {
          // since random gives [0.0.1), and want [0.0.{VAR(_coset_gcd)-1}]:
          int coset_id = (int) (floor(GOODRAND_01() * VAR(_coset_gcd)));
          double radians_to_close = VAR(_cycles_to_close_curve) * M_2PI;
          VAR(_initial_theta_radians) = radians_to_close * ((double) coset_id / (double) VAR(_coset_z));
          if (VAR(_DEBUG_COSETS) && count % 50000 == 0) {
            System.out.println("gcd: " + VAR(_coset_gcd) + ", lcm: " + VAR(_coset_lcm) + ", VAR(_cycles): " + VAR(_cycles) + ", coset: " + coset_id);
          }
        }
      }
    }

    if (VAR(meta_mode) != OFF) {
      // determine which meta-step to use
      //    should round instead?
      VAR(_current_meta_step) = (int) (GOODRAND_01() * VAR(_meta_steps));
      double meta_value = VAR(meta_min_step) + (VAR(_current_meta_step) * VAR(_meta_step_value));
      if (VAR(meta_mode) == LINE_OFFSET_INCREMENT) {
        // VAR(_coset_d) = VAR(meta_min_step) + (VAR(_current_meta_step) * VAR(_meta_step_value));'
        double line_offset = meta_value;
        if (VAR(irrationalize) != 0) {
          line_offset += (VAR(irrationalize) * 0.01 * M_E);
        }
        VAR(_theta_step_radians) = M_2PI * (line_offset / 360);
        VAR(_cycles) = (VAR(line_count) * VAR(_theta_step_radians)) / M_2PI;
        // actual_step_size = meta_min_step_radians + (meta_step_diff_radians * VAR(_current_meta_step));
        //      actual_step_size = M_2PI * (((int)(GOODRAND_01()* 60)+10)/360.0);
      } else if (VAR(meta_mode) == INITIAL_OFFSET) {
        double initial_offset = meta_value;
        VAR(_initial_theta_radians) = M_2PI * (initial_offset / 360);
      } else if (VAR(meta_mode) == A_LINEAR_INCREMENT) {
        VAR(_a) = meta_value;
      } else if (VAR(meta_mode) == B_LINEAR_INCREMENT) {
        VAR(_b) = meta_value;
      } else if (VAR(meta_mode) == C_LINEAR_INCREMENT) {
        VAR(_c) = meta_value;
      } else if (VAR(meta_mode) == D_LINEAR_INCREMENT) {
        VAR(_d) = meta_value;
      } else if (VAR(meta_mode) == E_LINEAR_INCREMENT) {
        VAR(_e) = meta_value;
      } else if (VAR(meta_mode) == F_LINEAR_INCREMENT) {
        VAR(_f) = meta_value;
      } else if (VAR(meta_mode) == A_B_LINEAR_INCREMENT) {
        // treat VAR(_a) param as meta param -- VAR(meta_min_step) determines min
        // treat VAR(_b) similar, but VAR(b) determines min VAR(_b)
        VAR(_a) = meta_value;
        VAR(_b) = VAR(b) + (VAR(_current_meta_step) * VAR(_meta_step_value));
      } else if (VAR(meta_mode) == RENDER_MODIFIER1) {
        VAR(render_modifier1) = meta_value;
      } else if (VAR(meta_mode) == RENDER_MODIFIER2) {
        VAR(render_modifier2) = meta_value;
      } else if (VAR(meta_mode) == RENDER_MODIFIER3) {
        VAR(render_modifier3) = meta_value;
      }
      if (VAR(_DEBUG_META_MODE) && count % 50000 == 0) {
        System.out.println("count: " + count + ", metacount = " + (int) (count / 50000));
        System.out.println("meta_step: " + VAR(_current_meta_step));
        System.out.println("meta_value: " + meta_value);
        System.out.println("VAR(_a): " + VAR(_a));
        System.out.println("VAR(_b): " + VAR(_b));
      }
    }
}
...
boolean dynamicParameterExpansion (Variation* vp, String paramName) {
...
{
   VAR(_DEBUG_META_MODE) = false;
   VAR(_DEBUG_SAMPLING) = false;
   VAR(_DEBUG_DYNAMIC_PARAMETERS) = false;
   VAR(_DEBUG_COSETS) = false;
   VAR(_DEBUG_COSETS_INIT) = false;
   VAR(_DEBUG_TANGENTS) = false;
   VAR(_line_thickness_strategy) = 0.0;
   VAR(_meta_step_value) = 1;
   VAR(_sample_size) = 1000;
    setCurveParams(vp);

    curve = createCurve(VAR(curve_mode));
    ...
    */
    ...
    VAR(_curve_thickness) = VAR(curve_thickness) / 100;

    VAR(_theta_step_radians) = M_2PI * (VAR(theta_step_size) / 360);
    if (VAR(irrationalize) != 0) {
      VAR(_theta_step_radians) += (VAR(irrationalize) * 0.01 * M_E) / 360;
    }
    VAR(_initial_theta_radians) = M_2PI * (VAR(initial_theta) / 360);
    VAR(_cycles) = (VAR(line_count) * VAR(_theta_step_radians)) / M_2PI;

    VAR(_coset_d) = (int) floor(VAR(theta_step_size));
    VAR(_coset_z) = (int) floor(VAR(line_count));
    // VAR(_coset_gcd) = gcd(vp, VAR(_coset_d), VAR(_coset_z));
    // VAR(_coset_lcm) = lcm(vp, VAR(_coset_d), VAR(_coset_z));  
    VAR(_cycles_to_close_curve) = curve.getCyclesToClose();
    if (Double.isNaN(VAR(_cycles_to_close_curve))) {
      // if VAR(_cycles) to close is unknown, default to 1 cycle (M_2PI radians) 
      VAR(_cycles_to_close_curve) = 1;
    }

    if (VAR(cosets_mode) == HYBRID_COSETS) {
      VAR(_coset_z) = (int) (VAR(_coset_z) * VAR(_cycles_to_close_curve));   // WARNING: this may break for small VAR(line_count) and VAR(_cycles_to_close_curve) non-integer!
    }
    VAR(_coset_gcd) = gcd(vp, VAR(_coset_d), VAR(_coset_z));
    VAR(_coset_lcm) = lcm(vp, VAR(_coset_d), VAR(_coset_z));
    VAR(_lines_per_coset) = VAR(_coset_z) / VAR(_coset_gcd);   // lines per polyline (one polyline per coset)
    VAR(_coset_count) = VAR(_coset_gcd);
    double total_line_segments = VAR(_lines_per_coset) * VAR(_coset_count);

    if (VAR(cosets_mode) == CLASSIC_COSETS) {
      VAR(_cycles_to_close_polyline) = VAR(_coset_lcm) / VAR(_coset_z);
      VAR(_coset_step_size) = M_2PI * ((double) VAR(_coset_d) / (double) VAR(_coset_z));
    } else if (VAR(cosets_mode) == CLOSURE_COSETS || VAR(cosets_mode) == HYBRID_COSETS) {
      VAR(_cycles_to_close_polyline) = VAR(_cycles_to_close_curve) * (VAR(_coset_lcm) / VAR(_coset_z));
      // double z = VAR(_cycles_to_close_curve) * VAR(_coset_z);  // or VAR(_radians_to_close_curve) * VAR(_coset_z) / M_2PI
      // VAR(_lines_per_coset) = z / gcd(vp, VAR(_coset_d), (int)z);
      double radians_to_close = VAR(_cycles_to_close_curve) * M_2PI;
      VAR(_coset_step_size) = radians_to_close * ((double) VAR(_coset_d) / (double) VAR(_coset_z));
    }
    if (VAR(_DEBUG_COSETS_INIT) && (VAR(cosets_mode) != 0)) {
      System.out.println("cosets: => count|gcd: " + VAR(_coset_gcd) + ", lcm: " + VAR(_coset_lcm) +
              ", curve close: " + VAR(_cycles_to_close_curve) + ", line close: " + VAR(_cycles_to_close_polyline) + ", VAR(_coset_z): " + VAR(_coset_z) +
              ", VAR(_lines_per_coset): " + VAR(_lines_per_coset) + ", total lines: " + total_line_segments);
    }

    double raw_meta_steps = (VAR(meta_max_step) - VAR(meta_min_step)) / VAR(_meta_step_value);
    VAR(_meta_steps) = (int) raw_meta_steps;
    if (VAR(_DEBUG_META_MODE)) {
      System.out.println("min: " + VAR(meta_min_step));
      System.out.println("max: " + VAR(meta_max_step));
      System.out.println("diff: " + VAR(_meta_step_value));
      System.out.println("meta steps raw: " + raw_meta_steps);
      System.out.println("meta steps: " + VAR(_meta_steps));
    }
    ...
    if (VAR(_DEBUG_SAMPLING)) {
      System.out.println("sampling");
    }
    for (int i = 0; i < VAR(_sample_size); i++) {
      count++;
      setValues(vp);
      ...
      // theta1 = VAR(_theta_step_radians) * (int)(GOODRAND_01()*VAR(line_count));
      theta1 = GOODRAND_01() * VAR(_cycles) * M_2PI;   // if using cosets, VAR(_cycles) gets reset based on coset calcs in setValues(vp)
      // reusing end_point1
//      end_point1 = getCurveCoords(theta1, end_point1);
      ...
      theta2 = theta1 + VAR(_theta_step_radians);
      // reusing end_point2
      ...
      double point_angle = getPointAngle(vp, end_point1, end_point2);

      double raw_line_angle = atan2(ydiff, xdiff);  // atan2 range is [-Pi..+Pi]
      // if (raw_line_angle < 0) { line_angle += M_2PI; }   // map to range [0.0.+2Pi]
      ...
      // scale to range [0.0.1]; (0 parallel to y-axis, 1 parallel to x-axis)
      double line_angle = unscaled_line_angle / (M_PI / 2.0);
      double line_length = sqrt((xdiff * xdiff) + (ydiff * ydiff));
      VAR(_sampled_line_lengths)[i] = line_length;
      VAR(_sampled_line_angles)[i] = line_angle;
      VAR(_sampled_point_angles)[i] = point_angle;
      VAR(_sampled_speeds)[i] = s1;
      VAR(_sampled_thetas)[i] = theta1 / M_2PI;
    }
    if (VAR(_DEBUG_SAMPLING)) {
      System.out.println("sorting");
    }
    Arrays.sort(VAR(_sampled_line_lengths));
    Arrays.sort(VAR(_sampled_line_angles));
    Arrays.sort(VAR(_sampled_point_angles));
    Arrays.sort(VAR(_sampled_speeds));
    Arrays.sort(VAR(_sampled_thetas));
    if (VAR(_DEBUG_SAMPLING)) {
      System.out.println("low line length: " + VAR(_sampled_line_lengths)[0]);
      System.out.println("high line length: " + VAR(_sampled_line_lengths)[VAR(_sample_size) - 1]);
      System.out.println("low line angle: " + VAR(_sampled_line_angles)[0]);
      System.out.println("high line angle: " + VAR(_sampled_line_angles)[VAR(_sample_size) - 1]);
      System.out.println("low point angle: " + VAR(_sampled_point_angles)[0]);
      System.out.println("high point angle: " + VAR(_sampled_point_angles)[VAR(_sample_size) - 1]);
      System.out.println("low speed: " + VAR(_sampled_speeds)[0]);
      System.out.println("high speed: " + VAR(_sampled_speeds)[VAR(_sample_size) - 1]);
    }
...
int PluginVarCalc(Variation* vp)
{
    ...
    double tin;
    if (VAR(randomize)) {
      // tin = (GOODRAND_01() * M_2PI) - M_PI; // random angle, range [-Pi .. +Pi]
      tin = (GOODRAND_01() * M_2PI); // random angle, range [0.0. +2Pi]
    } else {
      tin = atan2(yin, xin); // polar coordinate angle (theta in radians) of incoming point [-Pi .. +Pi]
    }
    double t = VAR(_cycles) * tin; // theta parameter for curve calculation
    ...
    // map to VAR(_a) Maurer Rose line
    // find nearest step
    step_number = floor(t / VAR(_theta_step_radians));
    // find distance along line??
    // find radians per full line
    // double line_fraction = (t % VAR(_theta_step_radians))/radians_per_full_line

    // find polar and cartesian coordinates for endpoints of Maure Rose line
    theta1 = (step_number * VAR(_theta_step_radians)) + VAR(_initial_theta_radians);
    theta2 = theta1 + VAR(_theta_step_radians);
    ...
    */
    ...
    // slope of line (m in y=mx+VAR(_b) line equation)
    double line_slope = ydiff / xdiff;
    // y-intercept of line (VAR(_b) in y=mx+VAR(_b) line equation)
    ...
    double raw_line_angle = atan2(ydiff, xdiff);  // atan2 range is [-Pi..+Pi]
    // if (raw_line_angle < 0) { raw_line_angle += M_2PI; }   // map to range [0.0.+2Pi]
    // delta_from_yaxis should be 0 if parallel to y-axis, and M_PI/2 if parallel to x-axis
    double unscaled_line_angle = abs(abs(raw_line_angle) - (M_PI / 2.0));
    // scale to range [0.0.1]; (0 parallel to y-axis, 1 parallel to x-axis)
    double line_angle = unscaled_line_angle / (M_PI / 2.0);
    ...
    // yoffset = [+-] line_slope * VAR(_d) / (sqrt(1 + line_slope^2))
    ...
    bool use_render_mode = true;
    if (VAR(show_points) > 0 || VAR(show_curve) > 0) {
      double rnd = GOODRAND_01();
      /**
       *  overrides of rendering mode
       */
      double xoffset = 0, yoffset = 0, zoffset = 0;
      double rand2 = GOODRAND_01();
      if (rand2 <= VAR(show_points)) {
        // drawing Maurer anchor points instead of specified VAR(render_mode)
        use_render_mode = false;
        if (VAR(_point_thickness) != 0) {
          double roffset = GOODRAND_01() * VAR(_point_thickness);
          double rangle = (GOODRAND_01() * M_2PI);
        ...
        zout = 0;
      } else if (rand2 <= (VAR(show_points) + VAR(show_curve))) {
        // drawing base curve instead of specified VAR(render_mode)
        use_render_mode = false;
        if (VAR(_curve_thickness) != 0) {
          xout = x + ((GOODRAND_01() - 0.5) * VAR(_curve_thickness));
          yout = y + ((GOODRAND_01() - 0.5) * VAR(_curve_thickness));
        } else {
          xout = x;
          yout = y;
        }
    ...
    if (use_render_mode) {
      double xoffset = 0, yoffset = 0, zoffset = 0;
      // pick VAR(_a) random point along the Maurer line specified by P1 and P2 endpoints
      // t1 ranges from [0.0.1] as line ranges from P1.0.P2
      // calculate the corresponding point PML along the Maurer line
      double t1 = GOODRAND_01();
       ...
       *   RENDER MODES
       */
      if (VAR(render_mode) == LINES || VAR(render_mode) == DEFAULT) {
        // draw lines
        xout = mpoint.x;
        yout = mpoint.y;
      } else if (VAR(render_mode) == CIRCLES) {
        // draw circles
        //   circles centered on midpoint of "Maurer line"
        //   and use midlength of Maurer line as radius
        if (VAR(render_submode) == Z_STROKE) {
          double ang = t1 * M_2PI;
      ...
      } else if (VAR(render_mode) == QUADRATIC_BEZIER) {
        ...
        // double bt = GOODRAND_01();  // want bt => [0:1]
        double bt = t1;
        double ax, ay;
        // use full formula with control point
        if (VAR(render_modifier1) != 1 || VAR(render_modifier2) != 1) {
          // VAR(render_modifier1) controls relative radius of control point
          ...
          // VAR(render_modifier2) controls relative angle of control point
          ...
          double cradius = (1 - VAR(render_modifier1)) * midpoint_radius;
          double cangle = midpoint_angle + (M_2PI - (VAR(render_modifier2) * M_2PI));
        ...
        // for now working on Z submodes here, but handling most submodes at end of transform(vp) method...
        if (VAR(render_submode) == Z_STROKE) {  // not really working
          zout = ay;
          xoffset = line_delta / sqrt(1 + line_slope * line_slope);
          if (x2 < x1) {
            xoffset = -1 * xoffset;
          }  // determine sign based on p2
          yoffset = abs(line_slope * xoffset);
          if (y2 < y1) {
            yoffset = -1 * yoffset;
          }
          xout = x1 + xoffset;
        ...
        else if (VAR(render_submode) == Z_BOTH_STROKE) {
      ...
      } else if (VAR(render_mode) == ELLIPSES) {
        if (VAR(render_submode) == Z_STROKE) {
          // ang ==> [-Pi : +Pi]  or [ 0 : 2Pi ] ?
          // double  ang = (GOODRAND_01() * M_2PI) - M_PI;  // ==> [ -Pi : +Pi ]
          // double ang = (GOODRAND_01() * M_2PI);   // ==> [ 0 : 2Pi ]
          double ang = t1 * M_2PI;

          // offset along line (relative to start of line)
          // if VAR(render_modifier1) == 1, then ranges are
          //    delta_from_midlength ==> [-midlength : +midlength]
          //    delta_from_start ==> [0 : line_length]
          double delta_from_midlength = (midlength * VAR(render_modifier1)) * cos(ang);
          ...
          double relative_perp_offset = (midlength * (VAR(render_modifier2) / 2)) * sin(ang);
          ...
          // 2D rotation transformation of point B about VAR(_a) given fixed point A to give point C
          ...
          // double ang = GOODRAND_01() * M_2PI;
          double ang = t1 * M_2PI;
          // double ang = (GOODRAND_01() * M_2PI) - M_PI;
          // offset along line (relative to start of line)
          double relative_line_offset = (midlength * VAR(render_modifier1)) * cos(ang);
      ...
      } else if (VAR(render_mode) == SINE_WAVES) {
        // amplitude calculated such that when render_modifier = 1, relative_perp_offset range: [0 ==> line_length/2]
        double amplitude = (line_length / 4) * VAR(render_modifier1);
        double frequency = VAR(render_modifier2);
        // range of [0 -> 2Pi ]
        // double ang = GOODRAND_01() * M_2PI;
        double ang = t1 * M_2PI;
        ...
        // then consider (line_offset, perp_offset) as point and rotate around start point (x1, y1) ?
        // should already have angle (raw_line_angle)
        // 2D rotation about VAR(_a) given point  
        // oR.x = oP.x + (o.x - oP.x) * cos(theta) - (o.y - oP.y) * sin(theta)
        // oR.y = oP.y + (o.x - oP.x) * sin(theta) + (o.y - oP.y) * cos(theta)
        ...
        if (VAR(render_submode) == Z_STROKE) {
          ...
          // can save VAR(_a) sin() call by using slope-intercept once have xout
      ...
      } else if (VAR(render_mode) == SEQUIN_CIRCLE_SPLINE) {
        ...
        double theta0 = theta1 - VAR(_theta_step_radians);
        double theta3 = theta2 + VAR(_theta_step_radians);
        ...
        // a2 = arccos(E @ D)
        double a1 = acos((vecA.x * vecC.x) + (vecA.y * vecC.y));
        double a2 = acos((vecE.x * vecD.x) + (vecE.y * vecD.y));

        // trigonometric angle blending function between P0 and P1:
        // VAR(_a)(u) = (a1 * cos^2(u*Pi/2)) + (a2 * sin^2(u*Pi/2))
        double u = t1;  // already have t1:[0=>1]
        double cu = cos(u * M_PI / 2);
        double su = sin(u * M_PI / 2);
        double au = (a1 * cu * cu) + (a2 * su * su);
        // now can calculate distance of P(u), VAR(_d)(P(u)) from P1:
        //  VAR(_b) = |P2-P1|  ==> should already have this as line length for current Maurer line
        //  VAR(_d)(P(u)) = VAR(_b) * sin(u * VAR(_a)(u)) / sin(VAR(_a)(u))
        double bp = norm21;  // same as line_length?
        double pd = bp * sin(u * au) / sin(au);

        // and deviation angle from Maurer line is 
        //  dangle(u) = (1-u) * VAR(_a)(u)
        double pa = (1 - u) * au;
        pa = -pa; // ???

        // then place point along Maurer line P1P2 at distance VAR(_d)(P(u)) from endpoint P1, 
        // http://math.stackexchange.com/questions/409689/how-do-i-find-VAR(_a)-point-VAR(_a)-given-distance-from-another-point-along-VAR(_a)-line
      ...
      } else if (VAR(render_mode) == CARDINAL_SPLINE ||
              VAR(render_mode) == UNIFORM_CATMULL_ROM_SPLINE ||
              VAR(render_mode) == CARDINAL_SPLINE_SWIZZLE1 ||
              VAR(render_mode) == CARDINAL_SPLINE_SWIZZLE2 ||
              VAR(render_mode) == CARDINAL_SPLINE_SWIZZLE3) {
        ...
        // range from [0:1] along [0.0.line_length]
        ...
        curve.getCurvePoint(theta3, end_point3);
        double x0, y0, x3, y3;
        if (VAR(render_mode) == CARDINAL_SPLINE_SWIZZLE1) {
          x0 = end_point0.y;
          y0 = end_point0.x;
          x3 = end_point3.y;
          y3 = end_point3.x;
        } else if (VAR(render_mode) == CARDINAL_SPLINE_SWIZZLE2) {
          x0 = end_point3.x;
          y0 = end_point3.y;
          x3 = end_point0.x;
          y3 = end_point0.y;
        } else if (VAR(render_mode) == CARDINAL_SPLINE_SWIZZLE3) {
          x0 = end_point3.y;
          y0 = end_point3.x;
          x3 = end_point0.y;
          y3 = end_point0.x;
        } else {  // VAR(render_mode) == CARDINAL_SPLINE or UNIFORM_CATMULL_ROM_SPLINE
          x0 = end_point0.x;
          y0 = end_point0.y;
          x3 = end_point3.x;
          y3 = end_point3.y;
        ...
        // (I think this is VAR(_a) standard assumption for baseline Catmull-Rom, see for example http://cubic.org/docs/hermite.htm)
        // so 
        // M1 = (P2 - PO)/2
        // M2 = (P3 - P1)/2
        ...
        // also trying addition of VAR(_a) tightness parameter
        // for the case where tanscale = 1 (VAR(render_modifier1) = 0), 
        //      get the uniform Catmull-Rom spline as VAR(_a) special case of cardinal splines
        // for the case where transcale = 0 (VAR(render_modifier1) = 1), tangents have no effect
        double tanscale;
        if (VAR(render_mode) == UNIFORM_CATMULL_ROM_SPLINE) {
          tanscale = 1;
        } else {
          tanscale = (1 - VAR(render_modifier1));
        }
        ...
        xout = xnew;
        yout = ynew;
      } else if (VAR(render_mode) == NONUNIFORM_CATMULL_ROM_SPLINE ||
              VAR(render_mode) == CENTRIPETAL_CATMULL_ROM_SPLINE ||
              VAR(render_mode) == CHORDAL_CATMULL_ROM_SPLINE) {
        // cobbled together from:
        ...
        // 
        // Original Paper: "A Recursive Evaluation Algorithm for VAR(_a) Class of Catmull-Rom Splines", Barry and Goldman
        ...
        double alpha = 0;
        if (VAR(render_mode) == CENTRIPETAL_CATMULL_ROM_SPLINE) {
          alpha = 0.5;
        } else if (VAR(render_mode) == CHORDAL_CATMULL_ROM_SPLINE) {
          alpha = 1.0;
        } else {  // VAR(render_mode) == NONUNIFORM_CATMULL_ROM_SPLINE
        ...
        // and t[i+1] = (((x[i+1]-x[i])^2 + (y[i+1]-y[i])^2)^0.5)^VAR(_a) + t[i]
        //     t[i+1] = (((x[i+1]-x[i])^2 + (y[i+1]-y[i])^2))^(VAR(_a)/2) + t[i]
        // rewrite in terms of deltas, then can drop the last term
        // dt0 = t1-t0 = (((x1-x0)^2 + (y1-y0)^2)) ^(VAR(_a)/2)
        // dt1 = t2-t1
        // dt2 = t3-t2
        ...
        double dt0 = pow(((x1 - x0) * (x1 - x0) + (y1 - y0) * (y1 - y0)), (alpha / 2));
        double dt1 = pow(((x2 - x1) * (x2 - x1) + (y2 - y1) * (y2 - y1)), (alpha / 2));
        double dt2 = pow(((x3 - x2) * (x3 - x2) + (y3 - y2) * (y3 - y2)), (alpha / 2));
        ...
        // double tanscale = dt1;
        // also trying addition of VAR(_a) tightness parameter
        double tanscale = dt1 * (1 - VAR(render_modifier1));
        m1x = m1x * tanscale;
        m1y = m1y * tanscale;
        m2x = m2x * tanscale;
        m2y = m2y * tanscale;
      ...
      } else if (VAR(render_mode) == KOCHANEK_BARTELS_SPLINE ||
              VAR(render_mode) == KOCHANEK_BARTELS_SPLINE_SWIZZLE1 ||
              VAR(render_mode) == KOCHANEK_BARTELS_SPLINE_SWIZZLE2 ||
              VAR(render_mode) == KOCHANEK_BARTELS_SPLINE_SWIZZLE3) {
        // cobbled together from:
        // Online:
        ...
        double x0, y0, x3, y3;
        if (VAR(render_mode) == KOCHANEK_BARTELS_SPLINE_SWIZZLE1) {
          x0 = end_point0.y;
          y0 = end_point0.x;
          x3 = end_point3.y;
          y3 = end_point3.x;
        } else if (VAR(render_mode) == KOCHANEK_BARTELS_SPLINE_SWIZZLE2) {
          x0 = end_point3.x;
          y0 = end_point3.y;
          x3 = end_point0.x;
          y3 = end_point0.y;
        } else if (VAR(render_mode) == KOCHANEK_BARTELS_SPLINE_SWIZZLE3) {
          x0 = end_point3.y;
          y0 = end_point3.x;
          x3 = end_point0.y;
          y3 = end_point0.x;
        ...
        double tension = VAR(render_modifier1);
        double continuity = VAR(render_modifier2);
        double bias = VAR(render_modifier3);
        ...
        xout = xnew;
        yout = ynew;
      } else if (VAR(render_mode) == CUBIC_HERMITE_SPLINE ||
              VAR(render_mode) == CUBIC_HERMITE_HAPPY_ACCIDENT1 ||
              VAR(render_mode) == CUBIC_HERMITE_HAPPY_ACCIDENT2 ||
              VAR(render_mode) == CUBIC_HERMITE_HAPPY_ACCIDENT3 ||
              VAR(render_mode) == CUBIC_HERMITE_HAPPY_ACCIDENT4 ||
              VAR(render_mode) == CUBIC_HERMITE_HAPPY_ACCIDENT5) {
        ...
        // double w = theta1 + (GOODRAND_01() * (theta2 - theta1));
        ...
        double dt1, dt2;
        // use VAR(render_modifier2) as theta offset (- for dt1, + for dt2) to find points to determine tangent vectors
        if (VAR(tangent_submode) == THETA_TANGENT) {
          dt1 = theta1 - ((VAR(render_modifier2) / 360) * M_2PI);
          dt2 = theta2 + ((VAR(render_modifier2) / 360) * M_2PI);
        }
        // use VAR(render_modifier2) to determine Maurer anchor points to use for tangent vectors
        //    (-rm2*VAR(_theta_step_radians) for dt1, +rm2*theta_line_offset for dt2) 
        else if (VAR(tangent_submode) == INDEX_TANGENT) {
          dt1 = theta1 - (VAR(render_modifier2) * VAR(_theta_step_radians));
          dt2 = theta2 + (VAR(render_modifier2) * VAR(_theta_step_radians));
        } else {
          dt1 = theta1;
          dt2 = theta2;
        }
        ...
        if (VAR(render_mode) == CUBIC_HERMITE_HAPPY_ACCIDENT1 ||
                VAR(render_mode) == CUBIC_HERMITE_HAPPY_ACCIDENT2 ||
                VAR(render_mode) == CUBIC_HERMITE_HAPPY_ACCIDENT3 ||
                VAR(render_mode) == CUBIC_HERMITE_HAPPY_ACCIDENT4 ||
                VAR(render_mode) == CUBIC_HERMITE_HAPPY_ACCIDENT5) {
          // using wrong (but interesting) calculations for first derivative
          double k = VAR(_a) / VAR(_b);
          first_derivative_point1.x = -(cos(k * dt1) + VAR(_c)) * sin(dt1);
          first_derivative_point1.y = (cos(k * dt1) + VAR(_c)) * cos(dt1);
          first_derivative_point2.x = -(cos(k * dt2) + VAR(_c)) * sin(dt2);
          first_derivative_point2.y = (cos(k * dt2) + VAR(_c)) * cos(dt2);
          if (VAR(render_mode) == CUBIC_HERMITE_HAPPY_ACCIDENT2) {  // flip signs for x of tangents
            first_derivative_point1.x = -1 * first_derivative_point1.x;
            first_derivative_point2.x = -1 * first_derivative_point2.x;
          } else if (VAR(render_mode) == CUBIC_HERMITE_HAPPY_ACCIDENT3) { // flip signs for y of tangents
            first_derivative_point1.y = -1 * first_derivative_point1.y;
            first_derivative_point2.y = -1 * first_derivative_point2.y;
          } else if (VAR(render_mode) == CUBIC_HERMITE_HAPPY_ACCIDENT4) {  // flip signs for both x and y of tangents
            first_derivative_point1.x = -1 * first_derivative_point1.x;
            first_derivative_point2.x = -1 * first_derivative_point2.x;
            first_derivative_point1.y = -1 * first_derivative_point1.y;
            first_derivative_point2.y = -1 * first_derivative_point2.y;
          } else if (VAR(render_mode) == CUBIC_HERMITE_HAPPY_ACCIDENT5) { // flip tangent points
        ...
        if (Double.isNaN(tan1x) || Double.isNaN(tan1y) ||
          ...
          if (VAR(tangent_submode) == UNSCALED_TANGENT ||
                  VAR(tangent_submode) == UNSCALED_UNIT_TANGENT ||
                  VAR(tangent_submode) == UNSCALED_NORMAL ||
                  VAR(tangent_submode) == UNSCALED_UNIT_NORMAL) {
            tanscale = 1;
          ...
          if (VAR(tangent_submode) == NORMAL_VECTOR ||
                  VAR(tangent_submode) == UNIT_NORMAL ||
                  VAR(tangent_submode) == UNSCALED_NORMAL ||
                  VAR(tangent_submode) == UNSCALED_UNIT_NORMAL) {
          ...
          } else if (VAR(tangent_submode) == ROTATION_TANGENT) {
            // user VAR(render_modifier2) to determine angle (in degrees) to rotate tangent1
            // user VAR(render_modifier3) to determine angle (in degrees) to rotate tangent2
          ...
          // scale x of tangent by VAR(render_modifier2) param
          // scale y of tangent by VAR(render_modifier3) param
          else if (VAR(tangent_submode) == XY_SCALE_TANGENT) {
            dx1 = tan1x * VAR(render_modifier2);
            dx2 = tan2x * VAR(render_modifier2);
            dy1 = tan1y * VAR(render_modifier3);
            dy2 = tan2y * VAR(render_modifier3);
          ...
          if (VAR(tangent_submode) == UNIT_TANGENT ||
                  VAR(tangent_submode) == UNIT_NORMAL ||
                  VAR(tangent_submode) == UNSCALED_UNIT_TANGENT ||
                  VAR(tangent_submode) == UNSCALED_UNIT_NORMAL) {
          ...
          // apply tension -- use VAR(render_modifier1) as tension parameter for cubic Hermite interpolation
          //    by applying VAR(_a) (1 - tension) scaling factor to the tangent vector Hermite terms
          ...
          tanscale = (1 - VAR(render_modifier1)) * tanscale;
          ...
          // double tanscale10 = (1 + VAR(render_modifier2)) * tanscale;
          // double tanscale11 = (1 - VAR(render_modifier2)) * tanscale;
      ...
      else if (VAR(render_mode) == CUBIC_HERMITE_TANGENT_FORM2) {
        // using general cubic hermite spline, with tangent vectors determined by derivative of underlying curve
        ...
        // double ffw0 = (-k * sin(k*w0) * cos(w0)) - ((cos(k*w0)+VAR(_c)) * sin(w0));  // first x derivative at P0 (of rhodonea)
        // double ggw0 = (-k * sin(k*w0) * sin(w0)) + ((cos(k*w0)+VAR(_c)) * cos(w0));  // first y derivative at P0 (of rhodonea)
        ...
        // double ffw1 = (-k * sin(k*w1) * cos(w1)) - ((cos(k*w1)+VAR(_c)) * sin(w1));  // first x derivative at P1 (of rhodonea)       
        // double ggw1 = (-k * sin(k*w1) * sin(w1)) + ((cos(k*w1)+VAR(_c)) * cos(w1));  // first y derivative at P1 (of rhodonea)
        ...
        if (Double.isNaN(ffw0) || Double.isNaN(ggw0) || Double.isNaN(ffw1) || Double.isNaN(ggw1)) {
          ...
          if (VAR(_DEBUG_TANGENTS) && GOODRAND_01() < 0.01) {
            double point_threshold = GOODRAND_01();
      ...
      // 
      if (VAR(render_submode) == STROKE || VAR(render_submode) == DEFAULT) {
        // do nothing
      } else if (VAR(render_submode) == REFLECTED_STROKE) {
        double bc = (((x2 - x1) * (xout - x1)) + ((y2 - y1) * (yout - y1))) / (((x2 - x1) * (x2 - x1)) + ((y2 - y1) * (y2 - y1)));
        xout = (2 * (x1 + ((x2 - x1) * bc))) - xout;
        yout = (2 * (y1 + ((y2 - y1) * bc))) - yout;
      } else if (VAR(render_submode) == BOTH_STROKE) {
        if (GOODRAND_01() < 0.5) {  // reflect half the points, leave other half unaltered
          double bc = (((x2 - x1) * (xout - x1)) + ((y2 - y1) * (yout - y1))) / (((x2 - x1) * (x2 - x1)) + ((y2 - y1) * (y2 - y1)));
          xout = (2 * (x1 + ((x2 - x1) * bc))) - xout;
          yout = (2 * (y1 + ((y2 - y1) * bc))) - yout;
        }
      } else if (VAR(render_submode) == ALTERNATING_STROKE) {
        if (step_number % 2 != 0) { // reflect odd steps, leave even  steps unaltered
          double bc = (((x2 - x1) * (xout - x1)) + ((y2 - y1) * (yout - y1))) / (((x2 - x1) * (x2 - x1)) + ((y2 - y1) * (y2 - y1)));
          xout = (2 * (x1 + ((x2 - x1) * bc))) - xout;
          yout = (2 * (y1 + ((y2 - y1) * bc))) - yout;
        }
      } else if (VAR(render_submode) == FILL_TO_LINE || VAR(render_submode) == FILL_TO_CURVE) {
        DoublePoint2D opoint;
        if (VAR(render_submode) == FILL_TO_CURVE) {
          opoint = curve_point;
        } else {
          opoint = mpoint;
        }
        // randomly place point on line from outpoint to mpoint
        double rfill = GOODRAND_01();
        xout = (xout * (1 - rfill)) + (opoint.x * rfill);
        yout = (yout * (1 - rfill)) + (opoint.y * rfill);
      } else if (VAR(render_submode) == FILL_BETWEEN_LINE_CURVE) { // ignores render mode
        double rfill = GOODRAND_01();
        xout = (mpoint.x * (1 - rfill)) + (curve_point.x * rfill);
        yout = (mpoint.y * (1 - rfill)) + (curve_point.y * rfill);
      } else if (VAR(render_submode) == FILL_BETWEEN_LINE_CURVE_SWIZZLE) {  // ignores render mode
        double rfill = GOODRAND_01();
        xout = (mpoint.x * (1 - rfill)) + (curve_point.y * rfill);
        yout = (mpoint.y * (1 - rfill)) + (curve_point.x * rfill);
      } else if (VAR(render_submode) == REFLECTED_FILL_TO_LINE || VAR(render_submode) == REFLECTED_FILL_TO_CURVE) {
        DoublePoint2D opoint;
        if (VAR(render_submode) == REFLECTED_FILL_TO_CURVE) {
          opoint = curve_point;
        } else {
          opoint = mpoint;
        }
        ...
        xout = (xout * (1 - rfill)) + (opoint.x * rfill);
        yout = (yout * (1 - rfill)) + (opoint.y * rfill);
      } else if (VAR(render_submode) == BOTH_FILL_TO_LINE || VAR(render_submode) == BOTH_FILL_TO_CURVE) {
        DoublePoint2D opoint;
        if (VAR(render_submode) == BOTH_FILL_TO_CURVE) {
          opoint = curve_point;
        } else {
          opoint = mpoint;
        }
        ...
        xout = (xout * (1 - rfill)) + (opoint.x * rfill);
        yout = (yout * (1 - rfill)) + (opoint.y * rfill);
      } else if (VAR(render_submode) == ALTERNATING_FILL_TO_LINE || VAR(render_submode) == ALTERNATING_FILL_TO_CURVE) {
        DoublePoint2D opoint;
        if (VAR(render_submode) == ALTERNATING_FILL_TO_CURVE) {
          opoint = curve_point;
        } else {
          opoint = mpoint;
        }
...
//      else if (VAR(render_submode) == CIRCLE_EXTRUDE) {
//        
//      }

      // handling thickness
      if (VAR(_line_thickness) != 0) {
        if (VAR(_line_thickness_strategy) == RANDOM) {  //  previous simple random offset from center of line 
          xout += ((GOODRAND_01() - 0.5) * VAR(_line_thickness));
          yout += ((GOODRAND_01() - 0.5) * VAR(_line_thickness));
        } else if (VAR(_line_thickness_strategy) == PERPENDICULAR) { // random distance _perpendicular_ to unmodified Maurer line;
          double xnorm = xdiff / line_length;
          double ynorm = ydiff / line_length;
          double xperpnorm = -ynorm;
          double yperpnorm = xnorm;
          double perp_offset = (GOODRAND_01() - 0.5) * VAR(_line_thickness);
          double xperp = perp_offset * xperpnorm;
          double yperp = perp_offset * yperpnorm;
          xout += xperp;
          yout += yperp;
        } else if (VAR(_line_thickness_strategy) == ROUNDED_CAPS) { // random distance _perpendicular_ to unmodified Maurer line, but with rounded caps
          if (line_delta < VAR(_line_thickness) || ((line_length - line_delta) < VAR(_line_thickness))) {
            xout += ((GOODRAND_01() - 0.5) * VAR(_line_thickness));
            yout += ((GOODRAND_01() - 0.5) * VAR(_line_thickness));
          } else {
            double xnorm = xdiff / line_length;
    ...
    for (int findex = 0; findex < VAR(number_of_filters); findex++) {
      ...
      if (fmode != OFF) {
        ...
        if (measure == LINE_LENGTH_LINES) {
          val = line_length;
          sampled_vals = VAR(_sampled_line_lengths);
        } else if (measure == LINE_ANGLE_LINES) {
          val = line_angle;
          sampled_vals = VAR(_sampled_line_angles);
        } else if (measure == POINT_ANGLE_LINES) {
          val = point_angle;
          sampled_vals = VAR(_sampled_point_angles);
          ...
          val = MIN(line_delta, line_length - line_delta);
        ...
        bool inband = (val >= low_thresh && val <= high_thresh);
        bool current_pass;
    ...
    if (VAR(diff_mode)) {
      FPx = FTx + (VVAR * (xout - FTx));
      FPy = FTy + (VVAR * (yout - FTy));
      FPz = FTz + (VVAR * (zout - FTz));
    } else {
      FPx += VVAR * xout;
      FPy += VVAR * yout;
      FPz += VVAR * zout;
    ...
    */
    ...
    //  COLORING
    //
    if (VAR(direct_color_measure) != NONE && VAR(direct_color_gradient) != OFF) {
      double val;
      double[] sampled_vals;
      if (VAR(direct_color_measure) == LINE_LENGTH_LINES) {
        val = line_length;
        sampled_vals = VAR(_sampled_line_lengths);
      } else if (VAR(direct_color_measure) == SPEED_AT_ENDPOINT1) {
        // val = speed1;
        val = curve.getSpeed(theta1, end_point1);
        sampled_vals = VAR(_sampled_speeds);
      } else if (VAR(direct_color_measure) == CURRENT_THETA) {
        val = theta1 / M_2PI;
        sampled_vals = VAR(_sampled_thetas);
      } else if (VAR(direct_color_measure) == LINE_ANGLE_LINES) {
        val = line_angle;
        sampled_vals = VAR(_sampled_line_angles);
      } else if (VAR(direct_color_measure) == POINT_ANGLE_LINES) {
        val = point_angle;
        sampled_vals = VAR(_sampled_point_angles);
      } else if (VAR(direct_color_measure) == DISTANCE_ALONG_LINE_POINTS) {
        val = line_delta;
        sampled_vals = null;
      } else if (VAR(direct_color_measure) == DISTANCE_FROM_MIDLINE_POINTS) {
        val = abs(line_delta - midlength);
        sampled_vals = null;
      } else if (VAR(direct_color_measure) == META_INDEX && VAR(meta_mode) != OFF) {
        val = VAR(_current_meta_step);
        sampled_vals = null;
      } else if (VAR(direct_color_measure) == Z_MINMAX_POINTS) {
        // min/max zout should be +/- radius of circle ==> +/-(line_length/2)
        // val = abs(zout*2); // min/max zout should be
        val = zout + (line_length / 2); //  range of val should be 0 to line_length;
        sampled_vals = VAR(_sampled_line_lengths);
      } else if (VAR(direct_color_measure) == Z_ABSOLUTE_MINMAX_POINTS) {
        // min/max zout should be +/- radius of circle ==> +/-(line_length/2)
        val = abs(zout) * 2; // range of val should be 0 to line_length
        sampled_vals = VAR(_sampled_line_lengths);
      } else if (VAR(direct_color_measure) == DISTANCE_FROM_NEAREST_END_POINTS) {
        val = MIN(line_delta, line_length - line_delta);
        sampled_vals = null;  // percentiles calculated directly for DISTANCE_FROM_NEAREST_END_POINTS
      ...
      // ignore percentile option and VAR(direct_color_thresholding) if using META_INDEX mode??
      if (VAR(direct_color_measure) == META_INDEX && VAR(meta_mode) != OFF) {
        low_value = 0;
        high_value = VAR(_meta_steps);
      } else {
        if (VAR(direct_color_thresholding) == PERCENT) {
          if (VAR(direct_color_measure) == DISTANCE_ALONG_LINE_POINTS) {
            low_value = VAR(color_low_threshold) * line_length;
            high_value = VAR(color_high_threshold) * line_length;
          } else if (VAR(direct_color_measure) == DISTANCE_FROM_MIDLINE_POINTS) {
            low_value = VAR(color_low_threshold) * midlength;
            high_value = VAR(color_high_threshold) * midlength;
          } else if (VAR(direct_color_measure) == DISTANCE_FROM_MIDLINE_POINTS || VAR(direct_color_measure) == DISTANCE_FROM_NEAREST_END_POINTS) {
            // low_thresh and high_thresh for DISTANCE_FROM_MIDLINE_POINTS and DISTANCE_FROM_NEAREST_END_POINTS 
            //      can behave differently when thresholding by value, but act the same when thresholding by percentile
            low_value = VAR(color_low_threshold) * midlength;
            high_value = VAR(color_high_threshold) * midlength;
            ...
            int low_index, high_index;
            if (VAR(color_low_threshold) < 0 || VAR(color_low_threshold) >= 1) {
              low_index = 0;
            } else {
              low_index = (int) (VAR(color_low_threshold) * VAR(_sample_size));
            }
            if (VAR(color_high_threshold) >= 1 || VAR(color_high_threshold) < 0) {
              high_index = VAR(_sample_size) - 1;
            } else {
              high_index = (int) (VAR(color_high_threshold) * (VAR(_sample_size) - 1));
            }
            low_value = sampled_vals[low_index];
            high_value = sampled_vals[high_index];
          }
        } else {  // default is by value
          low_value = VAR(color_low_threshold);
          high_value = VAR(color_high_threshold);
        }
      ...
      if (VAR(direct_color_gradient) == COLORMAP_CLAMP) {
      ...
      } else if (VAR(direct_color_gradient) == COLORMAP_WRAP) {
        pVarTP.rgbColor = false;
      ...
      } else if (VAR(direct_color_gradient) == RED_GREEN) {  //
        pVarTP.rgbColor = true;
        pVarTP.redColor = baseColor;
        pVarTP.greenColor = 255 - baseColor;
        pVarTP.blueColor = 0;
      } else if (VAR(direct_color_gradient) == RED_BLUE) {
        pVarTP.rgbColor = true;
        pVarTP.redColor = baseColor;
        pVarTP.greenColor = 0;
        pVarTP.blueColor = 255 - baseColor;
      } else if (VAR(direct_color_gradient) == BLUE_GREEN) {
        pVarTP.rgbColor = true;
        pVarTP.redColor = 0;
        pVarTP.greenColor = 255 - baseColor;
