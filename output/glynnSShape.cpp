...
/*
    Apophysis Plugin: glynnSShape

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/GlynnSuperShapeFunc.java
...
#define APO_VARIABLE_PREFIX "glynnSShape_"
#include "plugin.h"

APO_PLUGIN("glynnSShape");
APO_VARIABLES(
	VAR_REAL(radius, 1.0),
	VAR_REAL(radius1, 0.5),
	VAR_REAL(thickness, 1.0),
	VAR_REAL(phi1, 0.0),
	VAR_REAL(m, 5),
	VAR_REAL(n1, 1.7),
	VAR_REAL(n2, 1.7),
