...
/*
    Apophysis Plugin: dc_kaleidoscopic

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/DC_KaleidoscopicFunc.java
...
#define APO_VARIABLE_PREFIX "dc_kaleidoscopic_"
#include "plugin.h"

APO_PLUGIN("dc_kaleidoscopic");
APO_VARIABLES(
