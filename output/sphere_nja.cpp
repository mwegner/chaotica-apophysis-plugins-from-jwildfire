...
/*
    Apophysis Plugin: sphere_nja

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/SphereNjaFunc.java
...
APO_PLUGIN("sphere_nja");
APO_VARIABLES(
	VAR_REAL(circle_a, 1.0),
	VAR_REAL(circle_b, 1.0),
...
int PluginVarCalc(Variation* vp)
{
    ...
    */
    ...
    double t = POINT_SQTR(ini) / VAR(stretch) - M_PI / 2;

    // circular curve, expanded by VVAR
    double r = cos(t) * VVAR;// * POINT_SQTR(ini);
    double z = sin(t) * VVAR;// * POINT_SQTR(ini);
