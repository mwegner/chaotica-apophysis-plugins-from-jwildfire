...
/*
    Apophysis Plugin: gamma

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/GammaFunc.java
...
int PluginVarCalc(Variation* vp)
{
    ...
    FPx += lgamma(hypot(FTy, FTx)) * VVAR;
    FPy += atan2(FTy, FTx) * VVAR;
