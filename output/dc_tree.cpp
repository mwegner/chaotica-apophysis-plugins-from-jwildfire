...
/*
    Apophysis Plugin: dc_tree

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/DC_TreeFunc.java
...
#define APO_VARIABLE_PREFIX "dc_tree_"
#include "plugin.h"
