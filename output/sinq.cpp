...
/*
    Apophysis Plugin: sinq

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/SinqFunc.java
...
#define APO_VARIABLE_PREFIX "sinq_"
#include "plugin.h"
...
// 
// public class SinqFunc extends SimpleVariationFunc {
...
//     double sh = sinh(abs_v);
//     double ch = cosh(abs_v);
//     double C = pAmount * c * sh / abs_v;
//     pVarTP.x += pAmount * s * ch;
