...
/*
    Apophysis Plugin: dc_circlesblue

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/DC_CirclesBlueFunc.java
...
#define APO_VARIABLE_PREFIX "dc_circlesblue_"
#include "plugin.h"

APO_PLUGIN("dc_circlesblue");
APO_VARIABLES(
