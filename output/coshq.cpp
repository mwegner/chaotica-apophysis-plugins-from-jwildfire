...
/*
    Apophysis Plugin: coshq

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/CoshqFunc.java
...
#define APO_VARIABLE_PREFIX "coshq_"
#include "plugin.h"
