...
/*
    Apophysis Plugin: cos2_bs

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/Cos2_BSFunc.java
...
#define APO_VARIABLE_PREFIX "cos2_bs_"
#include "plugin.h"
...
int PluginVarCalc(Variation* vp)
{
    ...
    //Cosine COS
    double cossin = sin(FTx * VAR(x1));
    double coscos = cos(FTx * VAR(x2));
    double cossinh = sinh(FTy * VAR(y1));
    double coscosh = cosh(FTy * VAR(y2));
...
// 
// public class Cos2_BSFunc extends VariationFunc {
