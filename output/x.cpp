...
/*
    ...
    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/XFunc.java
...
int PluginVarCalc(Variation* vp)
{
    ...
    r = VVAR * sqrt(sqr(FTx) + sqr(FTy) + sqr(total));
...
// 
// public class XFunc extends VariationFunc {
...
//     }
// 
//     r = pAmount * sqrt(sqr(pAffineTP.x) + sqr(pAffineTP.y) + sqr(total));
// 
//     s = sin(a);
//     c = cos(a);
// 
