...
/*
    Apophysis Plugin: dc_kaliset

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/DC_KaliSetFunc.java
...
#define APO_VARIABLE_PREFIX "dc_kaliset_"
#include "plugin.h"

APO_PLUGIN("dc_kaliset");
APO_VARIABLES(
