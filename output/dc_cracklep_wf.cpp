...
/*
    ...
    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/DCCracklePWFFunc.java
...
#define APO_VARIABLE_PREFIX "dc_cracklep_wf_"
#include "plugin.h"
...
boolean dynamicParameterExpansion (Variation* vp, String pName) {
    ...
    // VAR(preset) doesn't really expand parameters, but it changes them; this will make them refresh
