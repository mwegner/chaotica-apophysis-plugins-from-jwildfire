...
/*
    Apophysis Plugin: dc_crackle_wf

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/DCCrackleWFFunc.java
...
#define APO_VARIABLE_PREFIX "dc_crackle_wf_"
#include "plugin.h"

APO_PLUGIN("dc_crackle_wf");
APO_VARIABLES(
