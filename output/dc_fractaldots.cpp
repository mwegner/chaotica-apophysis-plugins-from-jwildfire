...
/*
    Apophysis Plugin: dc_fractaldots

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/DC_FractalDotsFunc.java
...
{
	double _s=spacing;
	double _c=G.length(uv)>circleSize?0.0:1.0;

} Variables;

#define APO_VARIABLE_PREFIX "dc_fractaldots_"
#include "plugin.h"

APO_PLUGIN("dc_fractaldots");
APO_VARIABLES(
