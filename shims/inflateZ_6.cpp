/*
    Apophysis Plugin: inflateZ_6

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/InflateZ_6Func.java
...
#define APO_VARIABLE_PREFIX "inflateZ_6_"
#include "plugin.h"
