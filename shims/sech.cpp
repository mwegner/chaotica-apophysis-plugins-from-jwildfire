/*
    Apophysis Plugin: sech

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/SechFunc.java
...
#define APO_VARIABLE_PREFIX "sech_"
#include "plugin.h"
