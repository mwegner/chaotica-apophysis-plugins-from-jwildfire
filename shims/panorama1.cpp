/*
    Apophysis Plugin: panorama1

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/Panorama1Func.java
...
#define APO_VARIABLE_PREFIX "panorama1_"
#include "plugin.h"
