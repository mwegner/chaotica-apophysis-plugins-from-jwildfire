/*
    Apophysis Plugin: synth

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/SynthFunc.java
...
#define APO_VARIABLE_PREFIX "synth_"
#include "plugin.h"
...
APO_VARIABLES(
	...
	VAR_REAL(power, -2.0),
	VAR_REAL(mix, 1.0),
	VAR_INTEGER(smooth, 0),
	VAR_REAL(b, 0.0),
	VAR_INTEGER(b_type, 0),
	VAR_REAL(b_skew, 0.0),
	VAR_REAL(b_frq, 1.0),
	VAR_REAL(b_phs, 0.0),
	VAR_INTEGER(b_layer, 0),
	VAR_REAL(c, 0.0),
	VAR_INTEGER(c_type, 0),
	VAR_REAL(c_skew, 0.0),
	VAR_REAL(c_frq, 1.0),
	VAR_REAL(c_phs, 0.0),
	VAR_INTEGER(c_layer, 0),
	VAR_REAL(d, 0.0),
	VAR_INTEGER(d_type, 0),
	VAR_REAL(d_skew, 0.0),
	VAR_REAL(d_frq, 1.0),
	VAR_REAL(d_phs, 0.0),
	VAR_INTEGER(d_layer, 0),
	VAR_REAL(e, 0.0),
	VAR_INTEGER(e_type, 0),
	VAR_REAL(e_skew, 0.0),
	VAR_REAL(e_frq, 1.0),
	VAR_REAL(e_phs, 0.0),
	VAR_INTEGER(e_layer, 0),
	VAR_REAL(f, 0.0),
	VAR_INTEGER(f_type, 0),
	VAR_REAL(f_skew, 0.0),
	VAR_REAL(f_frq, 1.0),
	VAR_REAL(f_phs, 0.0),
