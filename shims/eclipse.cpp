/*
    Apophysis Plugin: eclipse

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/EclipseFunc.java
...
#define APO_VARIABLE_PREFIX "eclipse_"
#include "plugin.h"
