/*
    Apophysis Plugin: xtrb

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/XTrbFunc.java
...
#define APO_VARIABLE_PREFIX "xtrb_"
#include "plugin.h"
