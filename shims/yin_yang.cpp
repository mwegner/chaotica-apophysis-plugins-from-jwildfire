/*
    Apophysis Plugin: yin_yang

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/YinYangFunc.java
...
#define APO_VARIABLE_PREFIX "yin_yang_"
#include "plugin.h"
