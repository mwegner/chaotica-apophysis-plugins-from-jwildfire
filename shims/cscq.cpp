/*
    Apophysis Plugin: cscq

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/CscqFunc.java
...
#define APO_VARIABLE_PREFIX "cscq_"
#include "plugin.h"
