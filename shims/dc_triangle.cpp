/*
    Apophysis Plugin: dc_triangle

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/DCTriangleFunc.java
...
#define APO_VARIABLE_PREFIX "dc_triangle_"
#include "plugin.h"
