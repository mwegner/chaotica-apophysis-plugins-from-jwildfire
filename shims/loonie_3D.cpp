/*
    Apophysis Plugin: loonie_3D

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/Loonie_3DFunc.java
...
#define APO_VARIABLE_PREFIX "loonie_3D_"
#include "plugin.h"
