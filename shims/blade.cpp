/*
    Apophysis Plugin: blade

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/BladeFunc.java
...
#define APO_VARIABLE_PREFIX "blade_"
#include "plugin.h"
