...
/*
    Apophysis Plugin: circleLinear

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/CircleLinearFunc.java
...
#define APO_VARIABLE_PREFIX "circleLinear_"
#include "plugin.h"
