...
/*
    Apophysis Plugin: dc_hoshi

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/DC_HoshiFunc.java
...
{
	double _x = 0.0; // p.y
	double _i; // x*x + G.atan2(p.y
	double _p.x) + time*0.02;
	double _h; // G.floor(i*4.0)/8.0 + 1.107

} Variables;

#define APO_VARIABLE_PREFIX "dc_hoshi_"
#include "plugin.h"
