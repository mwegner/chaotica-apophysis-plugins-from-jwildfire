...
/*
    Apophysis Plugin: gridout3D

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/Gridout3DFunc.java
...
typedef struct
{
	double _x; // rint(pAffineTP.x) * xx
	double _y; // rint(pAffineTP.y) * yy

} Variables;

#define APO_VARIABLE_PREFIX "gridout3D_"
#include "plugin.h"

APO_PLUGIN("gridout3D");
APO_VARIABLES(
