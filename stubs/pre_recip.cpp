...
/*
    Apophysis Plugin: pre_recip

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/PreRecipFunc.java
...
typedef struct
{
	double _xx = 0.0;
	double _yy = 0.0;
	double _xr = 0.0; // pAffineTP.x
	double _yr = 0.0; // pAffineTP.y

} Variables;

#define APO_VARIABLE_PREFIX "pre_recip_"
#include "plugin.h"

APO_PLUGIN("pre_recip");
APO_VARIABLES(
