...
/*
    Apophysis Plugin: sqrt_asech

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/Sqrt_AsechFunc.java
...
#define APO_VARIABLE_PREFIX "sqrt_asech_"
#include "plugin.h"

APO_PLUGIN("sqrt_asech");
APO_VARIABLES(
