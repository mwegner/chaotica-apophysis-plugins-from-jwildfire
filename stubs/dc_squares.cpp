...
/*
    Apophysis Plugin: dc_squares

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/DC_SquaresFunc.java
...
#define APO_VARIABLE_PREFIX "dc_squares_"
#include "plugin.h"

APO_PLUGIN("dc_squares");
APO_VARIABLES(
