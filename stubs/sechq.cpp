...
/*
    Apophysis Plugin: sechq

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/SechqFunc.java
...
#define APO_VARIABLE_PREFIX "sechq_"
#include "plugin.h"
