...
/*
    Apophysis Plugin: hexes

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/HexesFunc.java
...
#define APO_VARIABLE_PREFIX "hexes_"
#include "plugin.h"
