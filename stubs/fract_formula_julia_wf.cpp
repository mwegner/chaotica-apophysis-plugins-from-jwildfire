...
/*
    Apophysis Plugin: fract_formula_julia_wf

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/FractFormulaJuliaWFFunc.java
...
APO_PLUGIN("fract_formula_julia_wf");
APO_VARIABLES(
	VAR_INTEGER(power, 0),
	VAR_REAL(xseed, 0),
	VAR_REAL(yseed, 0)
