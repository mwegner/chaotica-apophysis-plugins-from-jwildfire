...
/*
    Apophysis Plugin: dc_mandbrot

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/DC_MandBrotFunc.java
...
typedef struct
{
	double _t=time/65.0*10.;

} Variables;

#define APO_VARIABLE_PREFIX "dc_mandbrot_"
#include "plugin.h"

APO_PLUGIN("dc_mandbrot");
APO_VARIABLES(
