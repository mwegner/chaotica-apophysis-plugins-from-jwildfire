...
/*
    Apophysis Plugin: glsl_circuits

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/GLSLCircuitsFunc.java
