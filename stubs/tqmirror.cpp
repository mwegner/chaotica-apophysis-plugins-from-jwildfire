...
/*
    Apophysis Plugin: tqmirror

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/TQMirrorFunc.java
...
typedef struct
{
	double _x = 0.0; // pAffineTP.x
	double _y = 0.0; // pAffineTP.y

} Variables;

#define APO_VARIABLE_PREFIX "tqmirror_"
#include "plugin.h"
