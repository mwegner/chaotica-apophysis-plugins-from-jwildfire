...
/*
    Apophysis Plugin: arctanh

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/ArctanhFunc.java
...
#define APO_VARIABLE_PREFIX "arctanh_"
#include "plugin.h"
