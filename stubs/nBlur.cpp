...
/*
    Apophysis Plugin: nBlur

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/NBlurFunc.java
...
#define APO_VARIABLE_PREFIX "nBlur_"
#include "plugin.h"

APO_PLUGIN("nBlur");
APO_VARIABLES(
	VAR_INTEGER(numEdges, 3),
	VAR_INTEGER(numStripes, 0),
	VAR_REAL(ratioStripes, 1.0),
	VAR_REAL(ratioHole, 0.0),
	VAR_INTEGER(circumCircle, 0),
