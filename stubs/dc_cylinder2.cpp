...
/*
    Apophysis Plugin: dc_cylinder2

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/DCCylinder2Func.java
...
#define APO_VARIABLE_PREFIX "dc_cylinder2_"
#include "plugin.h"

APO_PLUGIN("dc_cylinder2");
APO_VARIABLES(
	VAR_REAL(offset, 0.0),
	VAR_REAL(angle, 0.0),
	VAR_REAL(scale, 0.5),
