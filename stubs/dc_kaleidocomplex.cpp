...
/*
    Apophysis Plugin: dc_kaleidocomplex

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/DC_KaleidoComplexFunc.java
...
#define APO_VARIABLE_PREFIX "dc_kaleidocomplex_"
#include "plugin.h"

APO_PLUGIN("dc_kaleidocomplex");
APO_VARIABLES(
