...
/*
    Apophysis Plugin: glsl_kaliset2

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/GLSLKaliSet2Func.java
...
typedef struct
{
	...
	int _N = 100;
	double _rad2 = 1.0;
	double _shiftx = 0.0; // -0.356
	double _shifty = 0.686;
	double _FR = 1.8;
	double _FG = 1.9;
	double _FB = 2.2;
	int _gradient;
...
#define APO_VARIABLE_PREFIX "glsl_kaliset2_"
#include "plugin.h"
