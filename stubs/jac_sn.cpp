...
/*
    Apophysis Plugin: jac_sn

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/JacSnFunc.java
...
#define APO_VARIABLE_PREFIX "jac_sn_"
#include "plugin.h"
