...
/*
    Apophysis Plugin: dc_cube

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/DCCubeFunc.java
...
#define APO_VARIABLE_PREFIX "dc_cube_"
#include "plugin.h"
