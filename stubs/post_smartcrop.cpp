...
/*
    Apophysis Plugin: post_smartcrop

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/PostSmartCropFunc.java
...
typedef struct
{
	...
	int cropmode;
	int static;
	bool _post_scrop_mode;
	bool _post_scrop_radial;
	double _post_scrop_workradius;
	double _post_scrop_workpower;
	double _post_scrop_alpha;
	double _post_scrop_roundcoeff;
	double _post_scrop_x;
	double _post_scrop_y;
	double _post_scrop_z;
	double _post_scrop_c;

} Variables;

#define APO_VARIABLE_PREFIX "post_smartcrop_"
#include "plugin.h"
...
APO_VARIABLES(
	VAR_REAL(power, 4.0),
	VAR_REAL(radius, 1.0),
	VAR_REAL(roundstr, 0.0),
	VAR_REAL(roundwidth, 1.0),
	VAR_REAL(distortion, 1.0),
	VAR_REAL(edge, 0.0),
