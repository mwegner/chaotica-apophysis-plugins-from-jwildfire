...
/*
    Apophysis Plugin: q_ode

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/Q_odeFunc.java
...
typedef struct
{
	double q_ode01;
	double q_ode02;
	double q_ode03; // 1.0 - 2.0 * random01()
	double q_ode04; // 1.0 - 2.0 * random01()
	double q_ode05; // 1.0 - 2.0 * random01()
	double q_ode06; // 1.0 - 2.0 * random01()
	double q_ode07;
	double q_ode08;
	double q_ode09; // 1.0 - 2.0 * random01()
	double q_ode10; // 1.0 - 2.0 * random01()
...
APO_PLUGIN("q_ode");
APO_VARIABLES(
	VAR_REAL(q_ode01, 0.0),
	VAR_REAL(q_ode02, 1.0),
	VAR_REAL(q_ode03, 0),
	VAR_REAL(q_ode04, 0),
	VAR_REAL(q_ode05, 0),
	VAR_REAL(q_ode06, 0),
	VAR_REAL(q_ode07, 0.0),
	VAR_REAL(q_ode08, 1.0),
	VAR_REAL(q_ode09, 0),
	VAR_REAL(q_ode10, 0),
	VAR_REAL(q_ode11, 0),
	VAR_REAL(q_ode12, 0)
