...
/*
    Apophysis Plugin: hexnix3D

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/Hexnix3DFunc.java
...
typedef struct
{
	...
	double 3side; // scales the triangle within the hex - the 120 degree figure
	double _seg60x[6];
	double _seg60y[6];
	double _seg120x[3];
	double _seg120y[3];
...
#define APO_VARIABLE_PREFIX "hexnix3D_"
#include "plugin.h"
