...
/*
    Apophysis Plugin: jac_cn

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/JacCnFunc.java
...
#define APO_VARIABLE_PREFIX "jac_cn_"
#include "plugin.h"
