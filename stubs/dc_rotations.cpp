...
/*
    Apophysis Plugin: dc_rotations

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/DC_RotationsFunc.java
...
#define APO_VARIABLE_PREFIX "dc_rotations_"
#include "plugin.h"

APO_PLUGIN("dc_rotations");
APO_VARIABLES(
