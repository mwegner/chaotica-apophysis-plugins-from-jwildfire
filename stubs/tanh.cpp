...
/*
    Apophysis Plugin: tanh

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/TanhFunc.java
...
#define APO_VARIABLE_PREFIX "tanh_"
#include "plugin.h"
