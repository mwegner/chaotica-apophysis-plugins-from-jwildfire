...
/*
    Apophysis Plugin: quaternion

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/QuaternionFunc.java
...
APO_PLUGIN("quaternion");
APO_VARIABLES(
	VAR_REAL(cosqpow, 1.0),
	VAR_REAL(cosqx1, 1.0),
	VAR_REAL(cosqx2, 1.0),
	VAR_REAL(cosqy1, 1.0),
	VAR_REAL(cosqy2, 1.0),
	VAR_REAL(cosqz1, 1.0),
	VAR_REAL(cosqz2, 1.0),
	VAR_REAL(coshqpow, 0.0),
	VAR_REAL(coshqx1, 1.0),
	VAR_REAL(coshqx2, 1.0),
	VAR_REAL(coshqy1, 1.0),
	VAR_REAL(coshqy2, 1.0),
	VAR_REAL(coshqz1, 1.0),
	VAR_REAL(coshqz2, 1.0),
	VAR_REAL(cotqpow, 0.0),
	VAR_REAL(cotqx1, 1.0),
	VAR_REAL(cotqx2, 1.0),
	VAR_REAL(cotqy1, 1.0),
	VAR_REAL(cotqy2, 1.0),
	VAR_REAL(cotqz1, 1.0),
	VAR_REAL(cotqz2, 1.0),
	VAR_REAL(cothqpow, 0.0),
	VAR_REAL(cothqx1, 1.0),
	VAR_REAL(cothqx2, 1.0),
	VAR_REAL(cothqy1, 1.0),
	VAR_REAL(cothqy2, 1.0),
	VAR_REAL(cothqz1, 1.0),
	VAR_REAL(cothqz2, 1.0),
	VAR_REAL(cscqpow, 0.0),
	VAR_REAL(cscqx1, 1.0),
	VAR_REAL(cscqx2, 1.0),
	VAR_REAL(cscqy1, 1.0),
	VAR_REAL(cscqy2, 1.0),
	VAR_REAL(cscqz1, 1.0),
	VAR_REAL(cscqz2, 1.0),
	VAR_REAL(cschqpow, 0.0),
	VAR_REAL(cschqx1, 1.0),
	VAR_REAL(cschqx2, 1.0),
	VAR_REAL(cschqy1, 1.0),
	VAR_REAL(cschqy2, 1.0),
	VAR_REAL(cschqz1, 1.0),
	VAR_REAL(cschqz2, 1.0),
	VAR_REAL(estiqpow, 0.0),
	VAR_REAL(estiqx1, 1.0),
	VAR_REAL(estiqy1, 1.0),
	VAR_REAL(estiqy2, 1.0),
	VAR_REAL(estiqz1, 1.0),
	VAR_REAL(estiqz2, 1.0),
	VAR_REAL(logqpow, 0),
	VAR_REAL(logqbase, M_E),
	VAR_REAL(secqpow, 0.0),
	VAR_REAL(secqx1, 1.0),
	VAR_REAL(secqx2, 1.0),
	VAR_REAL(secqy1, 1.0),
	VAR_REAL(secqy2, 1.0),
	VAR_REAL(secqz1, 1.0),
	VAR_REAL(secqz2, 1.0),
	VAR_REAL(sechqpow, 0.0),
	VAR_REAL(sechqx1, 1.0),
	VAR_REAL(sechqx2, 1.0),
	VAR_REAL(sechqy1, 1.0),
	VAR_REAL(sechqy2, 1.0),
	VAR_REAL(sechqz1, 1.0),
	VAR_REAL(sechqz2, 1.0),
	VAR_REAL(sinqpow, 0.0),
	VAR_REAL(sinqx1, 1.0),
	VAR_REAL(sinqx2, 1.0),
	VAR_REAL(sinqy1, 1.0),
	VAR_REAL(sinqy2, 1.0),
	VAR_REAL(sinqz1, 1.0),
	VAR_REAL(sinqz2, 1.0),
	VAR_REAL(sinhqpow, 0.0),
	VAR_REAL(sinhqx1, 1.0),
	VAR_REAL(sinhqx2, 1.0),
	VAR_REAL(sinhqy1, 1.0),
	VAR_REAL(sinhqy2, 1.0),
	VAR_REAL(sinhqz1, 1.0),
	VAR_REAL(sinhqz2, 1.0),
	VAR_REAL(tanqpow, 0.0),
	VAR_REAL(tanqx1, 1.0),
	VAR_REAL(tanqx2, 1.0),
	VAR_REAL(tanqy1, 1.0),
	VAR_REAL(tanqy2, 1.0),
	VAR_REAL(tanqz1, 1.0),
	VAR_REAL(tanqz2, 1.0),
	VAR_REAL(tanhqpow, 0.0),
	VAR_REAL(tanhqx1, 1.0),
	VAR_REAL(tanhqx2, 1.0),
