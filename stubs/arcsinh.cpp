...
/*
    Apophysis Plugin: arcsinh

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/ArcsinhFunc.java
...
#define APO_VARIABLE_PREFIX "arcsinh_"
#include "plugin.h"
