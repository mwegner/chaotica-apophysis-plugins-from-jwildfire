...
/*
    Apophysis Plugin: falloff2

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/Falloff2Func.java
...
#define APO_VARIABLE_PREFIX "falloff2_"
#include "plugin.h"

APO_PLUGIN("falloff2");
APO_VARIABLES(
	VAR_REAL(scatter, 1.0),
	VAR_REAL(mindist, 0.5),
	VAR_REAL(mul_x, 1.0),
	VAR_REAL(mul_y, 1.0),
	VAR_REAL(mul_z, 0.0),
	VAR_REAL(mul_c, 0.0),
