...
/*
    Apophysis Plugin: dc_ztransl

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/DCZTranslFunc.java
...
#define APO_VARIABLE_PREFIX "dc_ztransl_"
#include "plugin.h"
