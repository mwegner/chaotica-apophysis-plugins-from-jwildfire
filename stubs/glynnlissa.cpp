...
/*
    Apophysis Plugin: glynnlissa

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/GlynnLissaFunc.java
...
#define APO_VARIABLE_PREFIX "glynnlissa_"
#include "plugin.h"

APO_PLUGIN("glynnlissa");
APO_VARIABLES(
	VAR_REAL(radius, 1.0),
