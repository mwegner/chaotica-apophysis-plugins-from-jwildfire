...
/*
    Apophysis Plugin: fract_pearls_wf

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/FractPearlsWFFunc.java
...
#define APO_VARIABLE_PREFIX "fract_pearls_wf_"
#include "plugin.h"

APO_PLUGIN("fract_pearls_wf");
APO_VARIABLES(
	VAR_REAL(xseed, 0),
	VAR_REAL(yseed, 0)
