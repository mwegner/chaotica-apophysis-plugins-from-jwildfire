...
/*
    Apophysis Plugin: post_spin_z

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/PostSpinZFunc.java
...
#define APO_VARIABLE_PREFIX "post_spin_z_"
#include "plugin.h"
