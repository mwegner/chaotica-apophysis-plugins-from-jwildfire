...
/*
    Apophysis Plugin: bubble

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/BubbleFunc.java
...
#define APO_VARIABLE_PREFIX "bubble_"
#include "plugin.h"
