...
/*
    Apophysis Plugin: sinh

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/SinhFunc.java
...
#define APO_VARIABLE_PREFIX "sinh_"
#include "plugin.h"
