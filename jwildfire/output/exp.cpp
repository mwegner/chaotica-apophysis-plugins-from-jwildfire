/*
    Apophysis Plugin: exp

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/ExpFunc.java
...
#define APO_VARIABLE_PREFIX "exp_"
#include "plugin.h"
...
int PluginVarCalc(Variation* vp)
{
    ...
    //Exponential EXP
    double expe = exp(FTx);
    double expsin = sin(FTy);
    double expcos = cos(FTy);
