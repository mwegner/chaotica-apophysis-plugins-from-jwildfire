/*
    Apophysis Plugin: cosq

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/CosqFunc.java
...
#define APO_VARIABLE_PREFIX "cosq_"
#include "plugin.h"
