/*
    Apophysis Plugin: sinh2_bs

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/Sinh2_BSFunc.java
...
#define APO_VARIABLE_PREFIX "sinh2_bs_"
#include "plugin.h"
...
int PluginVarCalc(Variation* vp)
{
    ...
    double sinhsin = sin(FTy * VAR(y1));
    double sinhcos = cos(FTy * VAR(y2));
    double sinhsinh = sinh(FTx * VAR(x1));
    double sinhcosh = cosh(FTx * VAR(x2));
    FPx += VVAR * sinhsinh * sinhcos;
    FPy += VVAR * sinhcosh * sinhsin;
...
// 
// public class Sinh2_BSFunc extends VariationFunc {
