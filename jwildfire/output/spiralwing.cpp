/*
    Apophysis Plugin: spiralwing

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/SpiralwingFunc.java
...
#define APO_VARIABLE_PREFIX "spiralwing_"
#include "plugin.h"

APO_PLUGIN("spiralwing");
APO_VARIABLES(
...
int PluginVarCalc(Variation* vp)
{
    ...
    double c1 = sqr(FTx);
    double c2 = sqr(FTy);
    double d = VVAR / (c1 + c2 + SMALL_EPSILON);
    c2 = sin(c2); // speedup
