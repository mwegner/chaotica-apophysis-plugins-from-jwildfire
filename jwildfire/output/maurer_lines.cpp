...
typedef struct
{
	...
	double render_mode;
	double render_submode;
	double tangent_submode;
	...
	double show_points;
	double show_curve;
	double _line_thickness_strategy = RANDOM;
	...
	bool diff_mode;
	int curve_mode;
	int direct_color_gradient;
	int direct_color_measure;
	int direct_color_thresholding;
...
int PluginVarPrepare(Variation* vp)
{
   ...
   VAR(_line_thickness_strategy) = RANDOM;
