/*
    Apophysis Plugin: spherecrop

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/SphereCropFunc.java
...
int PluginVarCalc(Variation* vp)
{
    ...
    double rad = sqrt(FTx * FTx + FTy * FTy + FTz * FTz);
    double ang = atan2(FTy, FTx);
    double az = acos(FTz / rad);
