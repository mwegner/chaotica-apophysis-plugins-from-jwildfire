/*
    Apophysis Plugin: koch_js

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/KochFunc.java
...
void koch (Variation* vp, int n, double step, Turtle turtle) {

    if (n == 0) {
      turtle.goForward(step);
      return;
    }
    koch(vp, n - 1, step, turtle);
...
// 
//   public void koch(int n, double step, Turtle turtle) {
//     if (n == 0) {
//       turtle.goForward(step);
//       return;
//     }
