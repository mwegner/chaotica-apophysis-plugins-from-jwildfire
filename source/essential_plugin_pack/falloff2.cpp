...
2017: took out the nested functions for compatibility -bezo97
...
double4 __linear(double4 v_in, double4 mul, double4 random, double dist) {
...
double4 __radial(double4 v_in, double4 mul, double4 random, double dist) {
...
double4 __gaussian(double4 v_in, double4 mul, double4 random, double dist) {
...
int PluginVarCalc(Variation* vp)
{
	...
	double4 v_out; switch (param(type)) {
		case bt_linear: 	v_out = __linear(v_in,mul,random,dist); 	break;
		case bt_radial: 	v_out = __radial(v_in,mul,random,dist); 	break;
		case bt_gaussian: 	v_out = __gaussian(v_in,mul,random,dist); 	break;
	}
