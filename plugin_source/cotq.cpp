/*
    Apophysis Plugin: cotq

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/CotqFunc.java
...
#define APO_VARIABLE_PREFIX "cotq_"
#include "plugin.h"
