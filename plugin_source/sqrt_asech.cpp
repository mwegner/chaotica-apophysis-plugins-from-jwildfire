/*
    Apophysis Plugin: acosh

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/AcoshFunc.java
...
#define APO_VARIABLE_PREFIX "acosh_"
#include "plugin.h"
