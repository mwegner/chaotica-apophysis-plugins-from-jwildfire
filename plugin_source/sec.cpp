/*
    Apophysis Plugin: sec

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/SecFunc.java
...
#define APO_VARIABLE_PREFIX "sec_"
#include "plugin.h"
...
int PluginVarCalc(Variation* vp)
{
    ...
    //Secant SEC
    double secsin = sin(FTx);
    double seccos = cos(FTx);
    double secsinh = sinh(FTy);
    double seccosh = cosh(FTy);
