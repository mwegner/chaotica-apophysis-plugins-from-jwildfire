/*
    Apophysis Plugin: erf

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/ErfFunc.java
...
#define APO_VARIABLE_PREFIX "erf_"
#include "plugin.h"
