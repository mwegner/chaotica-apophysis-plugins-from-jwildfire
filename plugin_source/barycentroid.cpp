/*
    Apophysis Plugin: barycentroid

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/BarycentroidFunc.java
...
double sgn (Variation* vp, double v) {
...
int PluginVarCalc(Variation* vp)
{
    ...
    */
    ...
    double um = sqrt(sqr(u) + sqr(FTx)) * sgn(vp, u);
    double vm = sqrt(sqr(v) + sqr(FTy)) * sgn(vp, v);
