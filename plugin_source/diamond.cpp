/*
    Apophysis Plugin: diamond

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/DiamondFunc.java
...
#define APO_VARIABLE_PREFIX "diamond_"
#include "plugin.h"
...
{
    double length = (sqrt(FTx * FTx + FTy * FTy) + SMALL_EPSILON);
...
// 
// public class DiamondFunc extends SimpleVariationFunc {
