...
int PluginVarCalc(Variation* vp)
{
    ...
    if (GOODRAND_01() >= VAR(_cr)) {
      FTx = VVAR * (offsetX * VAR(_c) + roundX);
      FTy = VVAR * (offsetY * VAR(_c) + roundY);
    } else {
      if (fabs(offsetX) >= fabs(offsetY)) {
        if (offsetX >= 0.0) {
          FTx = VVAR * (offsetX * VAR(_c) + roundX + VAR(_cl));
          FTy = VVAR * (offsetY * VAR(_c) + roundY + VAR(_cl) * offsetY / offsetX);
        } else {
          FTx = VVAR * (offsetX * VAR(_c) + roundX - VAR(_cl));
          FTy = VVAR * (offsetY * VAR(_c) + roundY - VAR(_cl) * offsetY / offsetX);
        }
        ...
        if (offsetY >= 0.0) {
          FTy = VVAR * (offsetY * VAR(_c) + roundY + VAR(_cl));
          FTx = VVAR * (offsetX * VAR(_c) + roundX + offsetX / offsetY * VAR(_cl));
        } else {
          FTy = VVAR * (offsetY * VAR(_c) + roundY - VAR(_cl));
          FTx = VVAR * (offsetX * VAR(_c) + roundX - offsetX / offsetY * VAR(_cl));
        }
