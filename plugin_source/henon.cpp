/*
    Apophysis Plugin: henon

    Port of: https://github.com/thargor6/JWildfire/blob/master/src/org/jwildfire/create/tina/variation/HenonFunc.java
...
#define APO_VARIABLE_PREFIX "henon_"
#include "plugin.h"
